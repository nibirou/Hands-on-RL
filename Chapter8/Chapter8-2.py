...
# 接下来要对比 DQN 和 Double DQN 的训练情况，为了便于后续多次调用，
# 我们进一步将 DQN 算法的训练过程定义成一个函数。训练过程会记录下每个状态的最大值，
# 在训练完成后我们可以将结果可视化，
# 观测这些值存在的过高估计的情况，以此来对比 DQN 和 Double DQN 的不同。
...
if __name__ == "__main__":
    ...
    # plt.show()
    plt.savefig("./Chapter8/8_Dueling_DQN_on_Pendulum-v0_return.png")
